...
import com.specisl.ResideMenu.Views.CircularImageView;
...
public class ResideMenu extends FrameLayout {
    ...
    private View scrollViewLeftMenu, scrollViewRightMenu, scrollViewMenu;
    ...
    private void initViews(Context context, int customLeftMenuId,
        ...
        if (customLeftMenuId >= 0) {
            ...
            tvProfileName = (TextView) scrollViewLeftMenu.findViewById(R.id.tvProfileName);
            ivProfileImage = (CircularImageView) scrollViewLeftMenu.findViewById(R.id.ivProfileImage);
        }
    ...
    public void setProfileImage(String imageResourceUrl, int defaultImageResource) {
        imageLoader = ImageLoader.getInstance();
        options = new DisplayImageOptions.Builder()
                        .cacheInMemory(true)
                        .cacheOnDisk(true)
                        .showImageForEmptyUri(defaultImageResource)
                        .showImageOnLoading(defaultImageResource)
                        .showImageOnFail(defaultImageResource)
                        .build();
        imageLoader.displayImage(imageResourceUrl, ivProfileImage, options);
        ivProfileImage.setBorderColor(Color.parseColor("#FFBB00"));
        ivProfileImage.setBorderWidth(1);
    }
